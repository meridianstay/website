...
export const aboutSchema: {
  ...
  { key: 'founder', label: 'About the founder', hint: 'Body is the founder’s story. The first entry is the founder card.', itemLabel: 'Founder card', maxItems: 1, fields: { title: 'Name', meta: 'Role', image: 'Photo link', text: 'Quote' } },
  { key: 'team', label: 'Our team', hint: 'Teams or people.', itemLabel: 'Team', maxItems: 8, fields: { icon: 'Icon', title: 'Team or name', meta: 'Role or lead (optional)', image: 'Photo link (optional)', text: 'What they do' } },
