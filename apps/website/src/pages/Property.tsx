...
import { fallbackImage, formatDate, type PropertyDetail } from '@meridian/shared'
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
        <div className="lg:col-span-2 space-y-10">
          ...
          <section id="location" className="pt-8 border-t border-slate-200">
            ...
            <p className="text-sm text-slate-500 mb-4">{property.location}. The exact address is shared after booking.</p>
        ...
        <aside className="lg:sticky lg:top-28 h-max">
          <BookingBox property={property} initial={search} />
        </aside>
      </div>
