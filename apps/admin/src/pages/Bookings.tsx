...
import { formatPrice, propertyById, sampleBookings, sampleUsers } from '@meridian/shared'

export function Bookings() {
  return (
    <>
      <PageHeader title="Bookings" description="Every reservation across the platform." />
      <Panel>
